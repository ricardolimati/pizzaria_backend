...
const RemoveOrderConttroller_1 = require("./controllers/order/RemoveOrderConttroller");
...
router.delete('/order', isAuthenticated_1.isAuthenticated, new RemoveOrderConttroller_1.RemoveOrderController().handle);
